...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println(showResult.buildOutputStringOfDivision(divisionWithPeriodFinding, 1034, 15));
        System.out.println("-------------------");
        System.out.println(showResult.buildOutputStringOfDivision(divisionWithPeriodFinding, 500000, 2));
        System.out.println("-------------------");
        ...
        System.out.println("-------------------");
        System.out.println(showResult.buildOutputStringOfDivision(divisionWithPeriodFinding, 1474, 3));
        System.out.println("-------------------");
